...
const UpdateGalleryData = () => {
  const updatableGallery = useLoaderData();
  const {
    _id,
    name,
    chef,
  ...
  const handleUpdateGallery = (event) => {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        fetch(`https://coffee-shop-server-nhr5ha8ny-bishwajit-pauls-projects.vercel.app/update-gallery/${_id}`, {
          method: "PUT",
